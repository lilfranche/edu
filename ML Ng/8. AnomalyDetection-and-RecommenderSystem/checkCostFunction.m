...
% Creates a collaborative filering problem to check your J and grads.
% It will output the analytical grads produced by your code and
...
if ~exist('lambda', 'var') || isempty(lambda)   % Set lambda
    lambda = 0;
end
